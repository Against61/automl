...
class QualityGateService:
    def __init__(self, ralph_backlog: RalphBacklogService):
    ...
    async def evaluate(
        ...
        metric_value = self.select_metric_value(metrics, metric_key)
    ...
    def extract_requirement(
        ...
        return self._parse_quality_requirement_from_text(raw_goal)
    ...
    def _pick_metric_value(self, metrics: dict[str, Any], metric_key: str) -> Any | None:
    ...
    def select_metric_value(self, metrics: dict[str, Any], metric_key: str) -> float | None:
        raw_value = self._pick_metric_value(metrics, metric_key)
